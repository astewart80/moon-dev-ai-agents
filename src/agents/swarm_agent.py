...
SWARM_MODELS = {
    # 🌙 Active Claude Models (User's paid subscription)
    "claude": (True, "claude", "claude-sonnet-4-5"),  # Claude 4.5 Sonnet - Latest & Greatest!
    "opus": (True, "claude", "claude-opus-4-5-20251101"),  # 🌙 Claude Opus 4.5 - Most powerful!
    "haiku": (True, "claude", "claude-3-5-haiku-20241022"),  # Claude 3.5 Haiku - Fast & efficient!

    # 🔇 Disabled Models (API keys invalid or not available)
    #"deepseek": (True, "deepseek", "deepseek-chat"),  # DeepSeek Chat - API key invalid
    #"xai": (True, "xai", "grok-4-fast-reasoning"),  # Grok - API key invalid
    #"openrouter_qwen": (True, "openrouter", "qwen/qwen3-max"),  # OpenRouter - API key not configured
    #"openrouter_glm": (True, "openrouter", "z-ai/glm-4.6"),  # OpenRouter - API key not configured
    #"openrouter_gpt5_mini": (True, "openrouter", "openai/gpt-5-mini"),  # OpenRouter - API key not configured
    #"openai": (True, "openai", "gpt-5"),  # GPT-5 - API key not configured

    # 💡 To enable more models, add valid API keys to .env
}
...
CONSENSUS_REVIEWER_MODEL = ("claude", "claude-3-5-haiku-20241022")  # Using Claude Haiku (fast & efficient)
